  ...
  <div style="color: #666">
    ...
    <div style="margin: 10px 0">
      <div style="padding: 10px 0; border-bottom: 1px dashed #ccc" v-for="item in tableData" :key="item.id">
        <div class="pd-10" style="font-size: 20px; color: #3F5EFB; cursor: pointer" @click="$router.push('/front/articleDetail?id=' + item.blogId)">{{ item.blogname }}
        </div>
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      {
        this.request.get("/article/collect/page",{
              params:{
