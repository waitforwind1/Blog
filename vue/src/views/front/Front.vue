    ...
    <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee;">
      <div style="width: 300px; display: flex; padding-left: 30px;">
        <div style="width: 60px">
          <img src="../../assets/blog-solid.png" alt="" style="width: 50px; position: relative; top: 5px; right: 0">
        </div>
        <div style="flex: 1">欢迎来到个人博客系统</div>
      </div>
      <div style="flex: 1;">
        <el-menu :default-active="'1'" class="el-menu-demo" mode="horizontal" router>
          ...
          <el-menu-item index="/front/write">写文章</el-menu-item>
